  ...
  return (
    <footer className="page-footer">
      <div className="page-footer__row">
        <span>newt/ui · Apache-2.0 · built by WolfStar</span>
        <span>
          <a href="https://github.com/wolfstar-project">
            github.com/wolfstar-project
          </a>{" "}
          · <a href="/#installation">CLI</a> · <a href="/#cdn">CDN</a> ·{" "}
          <a href="https://github.com/wolfstar-project/newt-ui/tree/main/apps/www/content/docs/installation">
            Setup guides
          </a>
        </span>
      </div>
      <p className="page-footer__disclaimer">
        newt/ui is an independent, open-source project built by WolfStar. It is
        ...
        style. See{" "}
        <a href="https://github.com/wolfstar-project/newt-ui/blob/main/DISCLAIMER.md">
          DISCLAIMER.md
        </a>{" "}
        for details.
      </p>
