...
<template>
  <div class="flex flex-col gap-3 text-[15px] text-newt-text-secondary">
    <p>Ship it <CustomEmoji :src="spark" name="spark" /></p>
    <p><CustomEmoji :src="spark" name="spark" size="jumbo" /></p>
  </div>
</template>
