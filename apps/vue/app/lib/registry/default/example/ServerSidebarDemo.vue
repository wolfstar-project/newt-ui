...
import { ServerSidebar } from "@/lib/registry/default/block/server-sidebar"
import type { SidebarMember } from "@/lib/registry/default/block/server-sidebar"
...
<template>
  <ServerSidebar
    class="w-64"
    server-name="Build Club"
    :voice-channel="{ name: 'General voice', members: ['alex', 'sam'] }"
    :members="MEMBERS"
  />
</template>
