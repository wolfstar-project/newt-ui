...
import {
  ...
  ChannelWelcomeIcon,
  ChannelWelcomeTitle,
} from "@/lib/registry/default/ui/channel-welcome"
</script>
...
<template>
  <ChannelWelcome>
    ...
    <ChannelWelcomeDescription>
      This is the start of the #general channel. Say hello and tell us what you
      are building.
    </ChannelWelcomeDescription>
    <ChannelWelcomeAction>
    ...
    <ChannelWelcomeDate date-time="2026-01-14">
      14 January 2026
    </ChannelWelcomeDate>
  </ChannelWelcome>
</template>
