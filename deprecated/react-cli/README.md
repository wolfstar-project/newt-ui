...
`newtui` detects React projects and records `framework: "react"` in `components.json`. An existing config written by this CLI is migrated automatically — see the [`newtui` README](../../packages/cli/README.md).
