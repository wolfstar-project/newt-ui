...
`newtui` detects Vue projects and records `framework: "vue"` in `components.json`. An existing config written by this CLI is migrated automatically — see the [`newtui` README](../../packages/cli/README.md).
